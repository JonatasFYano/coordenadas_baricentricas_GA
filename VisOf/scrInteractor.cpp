...
/*===================================================================*/
void glButton::Draw_Label() /* Escreve no boto */ {
...
/*==============================================================*/
void glButton::Draw() /* Desenha o boto */ {
    ...
    if (this->visible) {
        ...
        glColor3fv(this->text_color);
        glRasterPos2f(this->edge.left + 0.005, this->edge.top + 0.1); // posiciona onde ser escrito no boto
        this->Draw_Label();
    }
...
/*==============================================================*/
void glButton::init(auxRect<float> edge_values, float * clr_edge, float * clr_btn, char * text) /* inicializa as variaveis dos botes*/ {
...
void glButton::setColor(float * text, float * btn) /* define as cores do texto e do boto*/ {
    for (int i = 0; i < 3; i++) {
...
bool scrInteractor::Get_Normal_Change() // Devolve a variavel que diz se o sinal das normais deve ser mudado ou no
{
...
/*===================================================================*/
void scrInteractor::MouseMotion(int x, int y) /*  acessada com o movimento do mouse, com o boto clicado*/ {
...
/*===================================================================*/
void scrInteractor::Init_Lights() /* define a iluminao da malha*/ {
...
/*===================================================================*/
void scrInteractor::setLights(bool lights_on) /* habilita ou no o uso da iluminao, de acordo com o modo de desenho da malha*/ {
    if (lights_on)
...
/*===================================================================*/
void scrInteractor::subMouse(int button, int state, int x, int y) /* coordena as aes dos botes de acordo com o clique do mouse*/ {
    char label[30];
    strcpy(label, "");
...
void scrInteractor::subDisplay() {
    ...
    sprintf(label, "PRESSIONA 'v' PARA MUDAR O PONTO DE PARTIDA");
    glRasterPos2f(0.77, 0.73);
    this->Draw_String(label);
